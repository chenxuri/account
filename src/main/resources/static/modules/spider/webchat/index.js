...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            url: baseURL+'/spider/webchat/list',     //请求后台的URL（*）
            method: 'get',           //请求方式（*）
            ...
            columns: [{
                ...
                formatter:function(value,row,index) {
                    ...
                    valign: '图标',
                    formatter:function (value,row,index) {
                        return '<a href="http://weixin.sogou.com/weixin?type=1&query='+row.wechatid+'&ie=utf8&s_from=input&_sug_=n&_sug_type_="  target="_blank" >'+'<img src="'+picUrl+row.wechatid+'/icon.png">'+'</a>'
