...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $table.bootstrapTable({
            url: baseURL+'/upms/user/list',     //请求后台的URL（*）
            method: 'get',           //请求方式（*）
    ...
    oTableInit.queryParams = function (params) {
        ...
        var temp = {  //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            sort: params.sort,
            order: params.order,
            username:$("#form-search").find("input[name='username']").val()
        };

       /*
        ,
        realname:$("#form-search").find("input[name='realname']").val()
       console.log(temp);
...
function add() {
    ...
    if(addParsley.isValid()){
        ...
        var saveData = {  username:$("#form-add").find("input[name='username']").val(),
            password:$("#form-add").find("input[name='password']").val(),
            type:$("#form-add").find("input[name='type'][checked]").val(),
            realName:$("#form-add").find("input[name='realName']").val(),
            phone:$("#form-add").find("input[name='phone']").val(),
            email:$("#form-add").find("input[name='email']").val(),
            gender:$("#form-add").find("input[name='gender'][checked]").val(),
